...
import com.hungtt.personal.service.WalletService;
...
/**
 * REST controller for managing {@link com.hungtt.personal.domain.Wallet}.
 */
@RestController
@RequestMapping("/api")
public class WalletResource {
    ...
    public ResponseEntity<WalletDTO> partialUpdateWallet(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, walletDTO.getId())
        );
    }
