  ...
  return (
    <div>
      <h2 id="group-heading" data-cy="GroupHeading">
        <Translate contentKey="moneyManagementApp.group.home.title">Groups</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="moneyManagementApp.group.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/group/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="moneyManagementApp.group.home.createLabel">Create new Group</Translate>
          </Link>
        </div>
      </h2>
        ...
        {groupList && groupList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="moneyManagementApp.group.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="moneyManagementApp.group.home.notFound">No Groups found</Translate>
            </div>
          )
        )}
      </div>
