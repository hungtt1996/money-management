  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="moneyManagementApp.group.home.createOrEditLabel" data-cy="GroupCreateUpdateHeading">
            <Translate contentKey="moneyManagementApp.group.home.createOrEditLabel">Create or edit a Group</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('moneyManagementApp.group.code')}
                id="group-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('moneyManagementApp.group.nameVi')}
                id="group-nameVi"
                name="nameVi"
                data-cy="nameVi"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('moneyManagementApp.group.nameEn')}
                id="group-nameEn"
                name="nameEn"
                data-cy="nameEn"
                type="text"
