...
export const CategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="moneyManagementApp.category.delete.question">
        <Translate contentKey="moneyManagementApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
